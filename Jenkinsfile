podTemplate(label: 'jenkins-slave-pod', 
    containers: [
  		containerTemplate(name: 'docker', image: 'camel.uangel.com:5000/images/docker-agent:1.0', imagePullPolicy: "Always", command: 'cat', ttyEnabled: true, envVars: [ containerEnvVar(key: "DOCKER_TLS_VERIFY", value: "1" ), containerEnvVar(key: "DOCKER_HOST", value: "tcp://sonar.uangel.com:2376" ), containerEnvVar(key: "DOCKER_CERT_PATH", value: "/home/jenkins/.docker/machine/certs/") ]),
