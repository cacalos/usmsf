...
docker build --build-arg command=$PACKAGE_NAME -f $SCRIPT_DIR/DockerfilePC -t $DOCKER_USER/$PACKAGE_DOCKER_NAME:latest $apd
docker push $DOCKER_USER/$PACKAGE_DOCKER_NAME:latest
